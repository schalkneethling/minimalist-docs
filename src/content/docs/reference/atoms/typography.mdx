...
<Aside>
  The type scale and as a result the font sizes differ between large
  viewports and small viewports. [See the table below for details](#default-font-sizes).
</Aside>
...
If you are unsure about typographic scales, I can highly recommend the incredible TypeScale tool by Jeremy Church. It is available at [typescale.com](https://typescale.com/).
